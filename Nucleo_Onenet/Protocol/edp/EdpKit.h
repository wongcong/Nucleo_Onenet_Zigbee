...
EDPKIT_DLL EdpPacket* PacketPushdata(const int8_t* dst_devid,
                                     const int8_t* data, uint32_t data_len);
 ...
 *          为空        EDP协议包生成失败
 */
EDPKIT_DLL EdpPacket* PacketCmdResp(const int8_t* cmdid, uint16_t cmdid_len,
 ...
 *          <0          解析失败, 具体失败原因见本h文件的错误码
 */
EDPKIT_DLL int32_t UnpackCmdReq(EdpPacket* pkg, int8_t** cmdid, uint16_t* cmdid_len,
